...
class TopbarManager extends Manager {
    ...
    openSettings(e) {
        ...
        let n;
        ["defaultShip", "defaultMission", "profileButton", "resourceTreshold", 'customSplit', "msu", "sim", "converter", "useClientTime", "keyboardActions", "showMenuResources", "shortcutsOnRight", "disablePlanetTooltips", "reduceLargeImages", "displayPlanetTimers", 'showMissionsSplitted', "expeditionValue", "expeditionRandomSystem", "expeditionRedirect", "expeditionBigShips", "expeditionShipRatio", "ignoreExpeShipsLoss", "ignoreConsumption", "displaySpyTable", "boardTab", "ptreTeamKey", "ptreLogs", "manageData", "debugMode"].forEach((e => {
    ...
    checkRaids(e, t) {
        ...
        document.querySelector(`.ui-tabs-panel[aria-labelledby="${n}"]`).querySelectorAll(".msg").forEach((e => {
            ...
            o.setAttribute("data-api-code", a), Util.addDom("div", {
                ...
                url: `https://${window.location.host}/game/index.php?page=messages&messageId=${n}&tabid=21&ajax=1`,
                callback: o => {
