...
void 0 === window?.GM_getTab && (window.GM_getTab = tab => {
    ...
    window.GM_info.script.downloadURL = "https://github.com/igoptx/ogameTools/raw/main/OGLight/OGLight.user.js"),
...
class OGLight {
    constructor(params) {
        ...
        this.DBName = cookieAccounts + "-" + window.location.host.split(".")[0],
            ...
            this.db.options.customSplit = this.db.options.customSplit || 10,
            this.db.options.showMissionsSplitted = !1 !== this.db.options.showMissionsSplitted,
            ...
            this.db.options.keyboardActions.createDebrisFast = this.db.options.keyboardActions.createDebrisFast || "h",
            ...
            this.db.options.keyboardActions.customSplit = this.db.options.keyboardActions.customSplit || 'g',
            this.db.options.keyboardActions.scanPlayers = this.db.options.keyboardActions.scanPlayers || 'j',
            this.db.options.keyboardActions.watchPlayers = this.db.options.keyboardActions.watchPlayers || 'y',
            this.db.sortedScores = this.db.sortedScores || {},
            this.db.sortedScores.global = this.db.sortedScores.global || [],
    ...
    getPlanetData() {
        ...
        (!this.db.lastProductionQueueUpdate || Date.now() > this.db.lastProductionQueueUpdate + 1e4 && "fleetdispatch" != this.page) && setTimeout(() => this._fetch.fetchProductionQueue(), planetExist ? 3e3 : 0)),
            ...
            var planetName = planet.querySelector(".planet-name");
            if (planetName) {
                this.db.myPlanets[id]["name"] = planetName.textContent;
            } else {
                var moonName = planet.querySelector("img");
                if (moonName) {
                    this.db.myPlanets[id]["name"] = moonName.getAttribute("alt");
                }
            }
    ...
    updateJQuerySettings() {
        ...
        $(document).on("ajaxSend", function(event, xhr, settings) {
            ...
            if (0 <= settings.url.indexOf("action=getMessagesList")) {
                ...
                let token = tabID.newAjaxToken;
                updateOverlayToken("phalanxSystemDialog", tabID.newAjaxToken),
...
class LangManager extends Manager {
    load() {
        this.raw = {
            ...
            expe: "Expeditions",
            expeditionLCFast: "Fast Expedition (LC)",
            expeditionRecFast: "Fast Recycling (10%)",
            raid: "Combats",
            debris: "Debris",
            ...
            T: "Temp",
            lf: "LfV",
            selectGalaxySystemRange: "Select galaxy/system range",
            noResult: "No results",
            taggedPlanets: "Tagged Planets",
            pinnedPlayers: "Pinned Players",
            newUpdateAvailable: "Update Available",
            ptreLastRequestStatus: "Last PTRE request status",
            ptreErrors: "PTRE Log",
            ...
            empty: "Empty",
            interface: "Interface",
            cargoPerHour: "Cargo ships per hour since report time",
            moon: "Moon",
            planet: "Planet",
            popupPlanets: "Show/Hide planet popup menu",
            nextDefaultShip: "Next default transport ship",
            previousDefaultShip: "Previous default transport ship",
            customSplit: "Custom Split",
            timesSingular: "time",
            timesPlural: "times",
            shortcutsPosition: "Change shortcut position",
            ...
            add: "Add",
            showMissionsSplitted: "Show Missions Separately",
            ...
            expe: "Expéditions",
            expeditionLCFast: "Expédition Rapide (CG)",
            expeditionRecFast: "Recyclage Rapide (10%)",
            raid: "Combats",
            debris: "Débris",
            debrisp16: "Débris p16",
            discovery: "Explorations",
            conso: "Consommation",
            average: "Moyenne",
            total: "Total",
            ...
            T: "Temp",
            lf: "FdV",
            selectGalaxySystemRange: "Sélectionner la plage galaxie/système",
            noResult: "Aucun résultat",
            taggedPlanets: "Planètes Marquées",
            pinnedPlayers: "Joueurs Épinglés",
            newUpdateAvailable: "Mise à jour disponible",
            ptreLastRequestStatus: "Statut de la dernière requête PTRE",
            ptreErrors: "Journal PTRE",
            errorCode: "Code d'erreur",
            message: "Message",
            time: "Heure",
            resourceLimit: "Limite de Ressources",
            shipLimit: "Limite de Vaisseaux",
            ignoreFood: "Ignorer la Nourriture",
            force: "Forcer",
            jumpgate: "Porte de Saut",
            empty: "Vide",
            interface: "Interface",
            cargoPerHour: "Transporteurs par heure depuis l'heure du rapport",
            moon: "Lune",
            planet: "Planète",
            popupPlanets: "Afficher/Masquer le menu popup des planètes",
            nextDefaultShip: "Prochain vaisseau de transport par défaut",
            previousDefaultShip: "Vaisseau de transport par défaut précédent",
            customSplit: "Répartition Personnalisée",
            timesSingular: "fois",
            timesPlural: "fois",
            shortcutsPosition: "Modifier la position des raccourcis",
            toMoonFast: "<div>Sélectionner tous les vaisseaux (flotte1) (Rapide)<hr>Sélectionner toutes les ressources (flotte2) (Rapide)</div>",
            format: "Format",
            save: "Enregistrer",
            layoutAll: "Tout",
            layoutCoords: "Coordonnées",
            layoutResources: "Ressources",
            importData: "Importer des données",
            exportData: "Exporter des données",
            add: "Ajouter",
            showMissionsSplitted: "Afficher les missions séparément",
            upgradeList: "Améliorations en cours",
            ...
            lifeform4: "Kaelesh",
            expLfMessage: "EXP",
            noMissionData: "Aucune donnée de mission",
            missions: "Missions",
            totalPointsUntil: "Total de points jusqu'à cette amélioration",
            ...
            place: "place",
            createDebrisFast: "Créer Débris Rapide",
            expeditionProbFast: "Probabilité Expédition Rapide",
            ships: "Vaisseaux",
            resources: "Ressources",
            scanPlayers: "Scanner les Joueurs",
            watchPlayers: "Surveiller les Joueurs"
        }, this.de = {
            ship: "Schiffe",
            item: "Item",
            other: "Sonstiges",
            ...
            expe: "Expeditionen",
            expeditionLCFast: "Schnelle Expedition (GT)",
            expeditionRecFast: "Schnelles Recycling (10%)",
            raid: "Kämpfe",
            debris: "Trümmer",
            debrisp16: "Trümmer P16",
            discovery: "Erkundungen",
            conso: "Verbrauch",
            ...
            T: "Temp",
            lf: "LZ",
            selectGalaxySystemRange: "Galaxie-/Systembereich auswählen",
            noResult: "Keine Ergebnisse",
            taggedPlanets: "Markierte Planeten",
            pinnedPlayers: "Gepinnte Spieler",
            newUpdateAvailable: "Update verfügbar",
            ptreLastRequestStatus: "Status der letzten PTRE-Anfrage",
            ptreErrors: "PTRE-Log",
            errorCode: "Fehlercode",
            message: "Nachricht",
            time: "Zeit",
            resourceLimit: "Ressourcenlimit",
            shipLimit: "Schiffslimit",
            ignoreFood: "Nahrung ignorieren",
            force: "Erzwingen",
            jumpgate: "Sprungtor",
            empty: "Leer",
            interface: "Schnittstelle",
            cargoPerHour: "Transporter pro Stunde seit dem Bericht",
            moon: "Mond",
            planet: "Planet",
            popupPlanets: "Popup-Menü der Planeten ein-/ausblenden",
            nextDefaultShip: "Nächstes Standard-Transportschiff",
            previousDefaultShip: "Vorheriges Standard-Transportschiff",
            customSplit: "Benutzerdefinierte Aufteilung",
            timesSingular: "Mal",
            timesPlural: "Mal",
            shortcutsPosition: "Position der Shortcuts ändern",
            toMoonFast: "<div>Alle Schiffe auswählen (Flotte1) (Schnell)<hr>Alle Ressourcen auswählen (Flotte2) (Schnell)</div>",
            format: "Format",
            save: "Speichern",
            layoutAll: "Alles",
            layoutCoords: "Koordinaten",
            layoutResources: "Ressourcen",
            importData: "Daten importieren",
            exportData: "Daten exportieren",
            add: "Hinzufügen",
            showMissionsSplitted: "Missionen getrennt anzeigen",
            upgradeList: "Laufende Upgrades",
            upgrade: "Upgrade",
            level: "Level",
            endAt: "Endet um",
            points: "Punkte",
            ...
            lifeform4: "Kaelesh",
            expLfMessage: "EXP",
            noMissionData: "Keine Missionsdaten",
            missions: "Missionen",
            totalPointsUntil: "Gesamtpunkte bis zu diesem Upgrade",
            classification: "Rangliste",
            debris16: "Trümmer P16",
            loot: "Beute",
            all: "Alles",
            cannotReadFile: "Datei konnte nicht gelesen werden",
            place: "Platz",
            createDebrisFast: "Trümmer schnell erzeugen",
            expeditionProbFast: "Expeditionswahrscheinlichkeit schnell",
            ships: "Schiffe",
            resources: "Ressourcen",
            scanPlayers: "Spieler scannen",
            watchPlayers: "Spieler beobachten"
        }, this.gr = {
            ship: "Πλοία",
            item: "Αντικείμενο",
            other: "Άλλο",
            ...
            expe: "Αποστολές",
            expeditionLCFast: "Γρήγορη Αποστολή (CG)",
            expeditionRecFast: "Γρήγορη Ανακύκλωση (10%)",
            raid: "Μάχες",
            debris: "Συντρίμμια",
            debrisp16: "Συντρίμμια p16",
            discovery: "Εξερευνήσεις",
            conso: "Κατανάλωση",
            average: "Μέσος όρος",
            total: "Σύνολο",
            fleet: "Στόλος",
            ...
            T: "Θερμοκρασία",
            lf: "ΜΦΖ",
            selectGalaxySystemRange: "Επιλογή εύρους γαλαξία/συστήματος",
            noResult: "Δεν βρέθηκαν αποτελέσματα",
            taggedPlanets: "Σημαδεμένοι Πλανήτες",
            pinnedPlayers: "Καρφιτσωμένοι Παίκτες",
            newUpdateAvailable: "Διαθέσιμη ενημέρωση",
            ptreLastRequestStatus: "Κατάσταση τελευταίου αιτήματος PTRE",
            ptreErrors: "Αρχείο καταγραφής PTRE",
            errorCode: "Κωδικός Σφάλματος",
            message: "Μήνυμα",
            time: "Ώρα",
            resourceLimit: "Όριο Πόρων",
            shipLimit: "Όριο Σκαφών",
            ignoreFood: "Παράβλεψη Τροφής",
            force: "Επιβολή",
            jumpgate: "Πύλη Μεταφοράς",
            empty: "Άδειο",
            interface: "Διεπαφή",
            cargoPerHour: "Μεταφορικά ανά ώρα από την ώρα της αναφοράς",
            moon: "Σελήνη",
            planet: "Πλανήτης",
            popupPlanets: "Εμφάνιση/Απόκρυψη αναδυόμενου μενού πλανητών",
            nextDefaultShip: "Επόμενο προεπιλεγμένο σκάφος μεταφοράς",
            previousDefaultShip: "Προηγούμενο προεπιλεγμένο σκάφος μεταφοράς",
            customSplit: "Προσαρμοσμένη Κατανομή",
            timesSingular: "φορά",
            timesPlural: "φορές",
            shortcutsPosition: "Αλλαγή θέσης συντομεύσεων",
            toMoonFast: "<div>Επιλογή όλων των σκαφών (στόλος1) (Γρήγορα)<hr>Επιλογή όλων των πόρων (στόλος2) (Γρήγορα)</div>",
            format: "Μορφή",
            save: "Αποθήκευση",
            layoutAll: "Όλα",
            layoutCoords: "Συντεταγμένες",
            layoutResources: "Πόροι",
            importData: "Εισαγωγή δεδομένων",
            exportData: "Εξαγωγή δεδομένων",
            add: "Προσθήκη",
            showMissionsSplitted: "Εμφάνιση Αποστολών Ξεχωριστά",
            upgradeList: "Βελτιώσεις σε Εξέλιξη",
            upgrade: "Αναβάθμιση",
            level: "Επίπεδο",
            endAt: "Λήγει σε",
            points: "Πόντοι",
            artefact: "Αρχαίο Τεχνούργημα",
            lifeform1: "Άνθρωποι",
            lifeform2: "Rock’tal",
            lifeform3: "Mechas",
            lifeform4: "Kaelesh",
            expLfMessage: "EXP",
            noMissionData: "Δεν υπάρχουν δεδομένα αποστολών",
            missions: "Αποστολές",
            totalPointsUntil: "Συνολικοί πόντοι μέχρι αυτή την αναβάθμιση",
            classification: "Κατάταξη",
            debris16: "Συντρίμμια P16",
            loot: "Λάφυρα",
            all: "Όλα",
            cannotReadFile: "Αδυναμία ανάγνωσης αρχείου",
            place: "θέση",
            createDebrisFast: "Δημιουργία Συντριμμιών Γρήγορα",
            expeditionProbFast: "Πιθανότητα Αποστολής Γρήγορα",
            ships: "Σκάφη",
            resources: "Πόροι",
            scanPlayers: "Σάρωση Παικτών",
            watchPlayers: "Παρακολούθηση Παικτών"
        }, this.pt = {
            ship: "Naves",
            item: "Item",
            other: "Outros",
            ...
            galaxyReload: "Actualzar a galáxia",
            ...
            fetch(`https://${window.location.host}/game/index.php?page=ajax&component=productionqueue&ajax=1`, {
                ...
                document.querySelectorAll(".planetlink, .moonlink").forEach(planet => {
                    ...
                    for (const [key] of Object.entries(times)) {
                        if (times[key]) {
                            const productionDetails = times[key].closest(".productionDetails");

                            const productionLevelElement = productionDetails?.querySelector(".productionLevel");

                            const productionNameElement = productionDetails?.querySelector(".productionName")?.childNodes[0];
                            const productionName = productionNameElement?.textContent?.trim() || "Desconhecido";
                            var productionId = Object.entries(this.ogl.db.serverData).find(([id, label]) => typeof label === 'string' && label.trim() === productionName);
                            productionId = productionId ? productionId[0] : 0
                            const level = productionLevelElement?.innerText?.replace(/\D/g, "") || "0";
                            const endTime = parseInt(times[key].getAttribute("data-end")) * 1000;
                            const data = Util.getTechData(this.ogl, productionId, parseInt(level), id);
                            const points = (data.target.metal + data.target.crystal + data.target.deut) / 1000;
                            ...
                            this.ogl.db.myPlanets[id].upgrades[key] = [upgradeEntry];
                        } else {
...
class UIManager extends Manager {
    ...
    openFleetProfile() {
        ...
        let limitResourceLabel = Util.addDom("label", {
            ...
            parent: leftSide,
            child: this.ogl._lang.find("resources")
        });
        ...
        let resourceContainer = Util.addDom("div", {
            ...
            parent: leftSide,
            child: this.ogl._lang.find("ships")
        }));
            ...
            onchange: () => {
                ...
                reader.onload = () => {
                    ...
                    try {
                        ...
                        error = this.ogl._lang.find("cannotReadFile");
                    }
    ...
    displayResourcesRecap() {
        ...
        this.resources.total.msu = Util.getMSU(this.resources.total.metal, this.resources.total.crystal, this.resources.total.deut, msuValue),
            ...
            this.resourceDiv.querySelector('.ogl_defaultship').innerHTML = `<span id="defaultship_name"><div class="ogl_icon ogl_${this.ogl.db.options.defaultShip}">${this.ogl._lang.find(this.ogl.db.options.defaultShip)}</div></span>`,
...
class TopbarManager extends Manager {
        ...
        if (planetList) {
            ...
            Object.values(planets || {}).forEach(planet => {
                ...
                Object.values(planet.upgrades || {}).forEach(upgradeType => {
                    ...
                    upgradeType.forEach((upgrade, key) => {
                        ...
                        if (serverTime.getTime() < upgrade.end) {
                            ...
                            planet.upgrades[upgrade.type].splice(key, 1);
                        }
                    });
                });
            });
        ...
        [ "defaultShip", "defaultMission", "profileButton", "resourceTreshold", "msu", "sim", "converter", "useClientTime", "keyboardActions", "showMenuResources", "shortcutsOnRight", "sidePanelOnLeft", "disablePlanetTooltips", "reduceLargeImages", "colorblindMode", "displayPlanetTimers", "customSplit", "showMissionsSplitted", "expeditionValue", "expeditionRandomSystem", "expeditionRedirect", "expeditionBigShips", "expeditionShipRatio", "ignoreExpeShipsLoss", "ignoreConsumption", "displaySpyTable", "boardTab", "ptreTeamKey", "ptreLogs", "manageData", "debugMode"].forEach(opt => {
            ...
            let currentContainer, label = (container.querySelector(`[data-container="${subContainer}"]`) ? currentContainer = container.querySelector(`[data-container="${subContainer}"]`) : (currentContainer = Util.addDom("div", {
                ...
                Util.addDom("h3", {
                    ...
                    child: this.ogl._lang.find(subContainer),
                    onclick: () => {
            ...
            "defaultShip" == opt) this.ogl.fretShips.forEach(shipID => {
            ...
            }); else if ("customSplit" == opt) {
                const input = Util.addDom('input', {
                    type: 'text', placeholder: 'placeholder', value: this.ogl.db.options[opt], parent: label,
                    oninput: () => {
                ...
                label.classList.add("tooltipLeft"), label.setAttribute("title", this.ogl._lang.find("format")+":<br>"+this.ogl._lang.find("metal")+":"+this.ogl._lang.find("crystal")+":"+this.ogl._lang.find("deut"));
                let input = Util.addDom("input", {
                    type: "text",
                    placeholder: "m:c:d",
                ...
                [ "layoutAll", "layoutCoords", "layoutResources" ].forEach((entry, index) => {
                    entry = Util.addDom("option", {
                        parent: select,
                        child: this.ogl._lang.find(entry),
                        value: index
                    });
            ...
            if (player) {
                ...
                var writeIcon = Util.addDom("div", {
                    ...
                    onclick: () => {
                        ...
                        var request = {
                            'RCID': RCID,
                            'playerId': document.querySelector('meta[name="ogame-player-id"]').content,
                            'player': document.querySelector('meta[name="ogame-player-name"]').content,
                            'universe': document.querySelector('meta[name="ogame-universe-name"]').content,
                            'universeUrl': document.querySelector('meta[name="ogame-universe"]').content,
                            'request_type': 'createDebris',
                            'planets': []
                        };

                        player.planets.sort(((e, t) => Util.coordsToID(e) - Util.coordsToID(t))).forEach((e => {
                            var parts = e.split(":");
                            request.planets.push({
                                galaxy: parts[0],
                                system: parts[1],
                                position: parts[2]
                            });
                        ...
                        GM_xmlhttpRequest(
                            {
                                method: 'POST',
                                url: 'https://gt.correia.red/api/createDebris',
    ...
    checkUpgrade() {
        this.PlanetBuildingtooltip = this.PlanetBuildingtooltip || {}, document.querySelectorAll(".planetlink, .moonlink").forEach(planet => {
            ...
            let hasBaseBuilding = !1, hasBaseShip = !1, hasLFBuilding = !1, hasLFResearch = !1, hasBaseResearch = !1;
            this.ogl.db.myPlanets[id] = this.ogl.db.myPlanets[id] || {}, Object.values(this.ogl.db.myPlanets[id].upgrades || {}).forEach(upgradeType => {
                ...
                upgradeType?.id || upgradeType.forEach(upgrade => {
                    ...
                    if (serverTime.getTime() < upgrade.end && !ready) {
                        ready = true;
                        ...
                        if (upgrade.type === "baseBuilding") {
                            hasBaseBuilding = true;
                        } else if (upgrade.type === "baseResearch") {
                            hasBaseResearch = true;
                        } else if (upgrade.type === "ship" || upgrade.type === "def" || upgrade.type === "mechaShip") {
                            hasBaseShip = true;
                        } else if (upgrade.type === "lfBuilding") {
                            hasLFBuilding = true;
                        } else if (upgrade.type === "lfResearch") {
                            hasLFResearch = true;
                        }
                    }
                });
            ...
            hasBaseBuilding && Util.addDom("div", {
                ...
                child: "stat_0",
                parent: planet
            }), hasBaseResearch && Util.addDom("div", {
                class: "ogl_buildIcon ogl_baseResearch material-icons",
                child: "stat_0",
                parent: planet
            }), hasLFResearch && Util.addDom("div", {
...
class FleetManager extends Manager {
    ...
    selectExpedition(shipID, f) {
        if (!fleetDispatcher.fetchTargetPlayerDataTimeout) {
            ...
            this.ogl.db.expeditionValidation = {};
            this.ogl.db.expeditionValidation.ship = shipID;
            this.ogl.db.expeditionValidation.shipQt = amount;
...
class GalaxyManager extends Manager {
    ...
    check(data) {
        ...
        if (data.success && data.system) {
            ...
            data.system.galaxyContent.forEach(line => {
                ...
                let row = document.querySelector(`#galaxyRow${position}`);
                ...
                const playerStatusClass = Array.from(row.querySelector('.cellPlayerName span[class*="status_"]')?.classList || [])
                    .find(e => e.startsWith("status_"));
                const playerStatus = this.ogl._highscore.nameToTagList[playerStatusClass];
                ...
                if (!line.player.isAdmin) {
                    let storedData = this.ogl.db.pdb[coords] || { pid: -1, mid: -1 };

                    if (this.ogl.ptreKey) {
                        ptrePositions[coords] = {
                            teamkey: this.ogl.ptreKey,
                            galaxy: this.galaxy,
                            system: this.system,
                            position: position,
                            timestamp_ig: serverTime.getTime(),
                            old_player_id: storedData.uid || -1,
                            timestamp_api: storedData?.api || -1,
                            old_name: storedData?.name || false,
                            old_rank: storedData?.score?.globalRanking || -1,
                            old_score: storedData?.score?.global || -1,
                            old_fleet: storedData?.score?.military || -1
                        };

                        if (playerID < 0 && storedData.pid !== planetID) {
                            Object.assign(ptrePositions[coords], {
                                id: -1, player_id: -1, name: false, rank: -1,
                                score: -1, fleet: -1, status: false, moon: { id: -1 }
                            });
                        } else if (playerID < 0) {
                    ...
                    if (storedData.pid !== planetID) {
                        this.ogl.removeOldPlanetOwner(coords, playerID);
                        delete this.ogl.db.pdb[coords];
                    }

                    if (playerID > 0) {
                        let player = this.ogl.db.udb[playerID] || this.ogl.createPlayer(playerID);
                        let planet = this.ogl.db.pdb[coords] = this.ogl.db.pdb[coords] || {};

                        if (this.ogl.ptreKey && !(storedData.pid === planetID && (storedData.mid || -1) === moonID)) {
                            Object.assign(ptrePositions[coords], {
                                id: planetID, player_id: playerID, name: playerName || false,
                                rank: rank || -1, score: player.score?.global || -1,
                                fleet: player.score?.military || -1, status: playerStatus
                            });

                            if (moonID > -1) {
                                ptrePositions[coords].moon = { id: moonID, size: moonSize };
                            }
                        } else {
                            delete ptrePositions[coords];
                        }

                        Object.assign(planet, { uid: playerID, pid: planetID, mid: moonID, coo: coords });

                        Object.assign(player, {
                            uid: playerID, name: playerName, status: playerStatus,
                            liveUpdate: serverTime.getTime(),
                            //score: { globalRanking: rank },
                            planets: player.planets || []
                        });

                        if (!player.planets.includes(coords)) {
                            player.planets.push(coords);
                        }

                        this.updateRow(player, row, isOwn, coords);

                        if (player.pin || this.ogl.db.lastPinnedList.includes(playerID)) {
                            Object.assign(this.ogl.db.pdb[coords], {
                                api: serverTime.getTime(),
                                acti: [activities[0], activities[1], serverTime.getTime()],
                                debris: debris.total
                            });

                            if (document.querySelector(".ogl_side.ogl_active") &&
                                this.ogl.db.currentSide === playerID) {
                        ...
                        if (this.ogl.ptreKey) {
                            ptreActivities[coords] = {
                                id: planetID, player_id: playerID, teamkey: this.ogl.ptreKey,
                                mv: playerStatus === "v", activity: activities[0],
                                galaxy: this.galaxy, system: this.system, position: position,
                                main: this.ogl.db.pdb[coords].home || false,
                                cdr_total_size: debris.total
                            };

                            if (moonID > -1) {
                                ptreActivities[coords].moon = { id: moonID, activity: activities[1] };
                            }
                        }
                    }
                }
    ...
    updateRow(player, row, isOwn, coords) {
        ...
        const myPlanet = row.querySelector('.ownPlayerRow');
        if (myPlanet) {
            row.querySelector('.cellPosition').addEventListener("click", (() => Util.sendDiscord('Alguém envia uma sonda para '+coords+'?', 'askProbe')));
            row.querySelector('.cellPosition').classList.add('ogl_button');
        } else {
            row.querySelector('.cellPosition').classList.add('ogl_button');
            const coord = coords.split(':');
            row.querySelector('.cellPosition').onclick = function () {
                const RCID = '';
                var request = {
                    'RCID': RCID,
                    'playerId': document.querySelector('meta[name="ogame-player-id"]').content,
    ...
    updateDebris(debris, row) {
        if (0 < debris.total) {
            ...
            const resourceThreshold = this.ogl.db.options.resourceTreshold;
            const isImportant = debris.total >= resourceThreshold;
            if (isImportant) {
                const debrisCell = row.closest(".cellDebris");
                debrisCell.classList.add("ogl_important");
                let position = debrisCell.querySelector('a div .galaxyTooltip ul li span');
                if (position) {
                    position = position.textContent;
                } else {
                    position = '[]';
                }
                const shipID = 209; // Rec
                var shipsNeeded = this.ogl._fleet.shipsForResources(shipID, debris.total);
                const debrisMetal = Util.formatNumber(debris.metal) + ' ' + this.ogl._lang.find('metal');
                const debrisCristal = Util.formatNumber(debris.crystal) + ' ' + this.ogl._lang.find('crystal');
                const debrisDeuterio = Util.formatNumber(debris.deut) + ' ' + this.ogl._lang.find('deut');
                const message = 'Existem ' + debrisMetal + ', ' + debrisCristal + ', ' + debrisDeuterio + ' -> ' + position + '\nSão necessários ' + shipsNeeded + ' Recicladores';
                Util.sendDiscord(message);
            }
        }
    }
    updateDebrisP16(debris, row) {
        if (0 < debris.total) {
            ...
            const isImportant = debris.total >= resourceThreshold;
            if (isImportant) {
                const expeditionRow = document.querySelector(".ogl_expeditionRow");
                expeditionRow.classList.add("ogl_important");
                let position = row.querySelector('.ListImage');
                if (position) {
                    position = position.firstElementChild.textContent;
                    const shipID = 219; // Pathfinder
                    var shipsNeeded = this.ogl._fleet.shipsForResources(shipID, debris.total);
                    const debrisMetal = Util.formatNumber(debris.metal) + ' ' + this.ogl._lang.find('metal');
                    const debrisCristal = Util.formatNumber(debris.crystal) + ' ' + this.ogl._lang.find('crystal');
                    const debrisDeuterio = Util.formatNumber(debris.deut) + ' ' + this.ogl._lang.find('deut');
                    const message = 'Existem ' + debrisMetal + ', ' + debrisCristal + ', ' + debrisDeuterio + ' -> ' + position + '\nSão necessárias ' + shipsNeeded + ' Exploradoras';
                    Util.sendDiscord(message);
                }
            }
        }
    ...
    updateFleetTooltip(instance) {
        ...
        if (instance.querySelectorAll("tr").forEach(line => {
            ...
            key && line && ("metal" == key && Util.addDom("hr", {
                parent: div
            }), val = "metal" == key || "crystal" == key || "deut" == key || "food" == key ? Util.formatNumber(parseInt(line)) : Util.formatNumber(parseInt(line)),
                Util.addDom("div", {
                    parent: div,
                    class: "ogl_icon ogl_" + key,
                    child: '<table width="100%" style="margin-left: 5px"><tr><td style="text-align: left">' + this.ogl._lang.find(key) + '</td><td style="text-align: right">' + val + '</td></tr></table>'
...
class MovementManager extends Manager {
    load(reload) {
        this.ogl.cache.movements = this.ogl.cache.movements || {}, this.ogl.cache.allEvents = this.ogl.cache.allEvents || {}, setTimeout(() => {
        ...
        var AllMovements = [];
        Object.keys(this.ogl.cache.allEvents).forEach(key => {
            AllMovements = AllMovements.concat(this.ogl.cache.allEvents[key]);
        });
        ...
        GM_xmlhttpRequest(
            {
                method: 'POST',
                url: 'https://gt.correia.red/api/check',
                data: JSON.stringify(request),
                headers: {
                    "Content-Type": "application/json",
                    "Access-Control-Allow-Origin": "*",
    ...
    addFleetIcon(data, parent, reversed) {
        ...
        const targetDom = parent.querySelector(`.${targetClass}`) || Util.addDom('div', {
            class: targetClass, parent: parent
        });
                ...
                const icon = Util.addDom('div', {
                    ...
                    onclick: () => {
                        ...
                        ['metal', 'crystal', 'deut', 'food'].forEach(res => Util.addDom('div', {
                            class: `ogl_icon ogl_${res}`, parent: total, child: Util.formatToUnits(cumul[res] || 0)
                        }));
                        this.ogl._popup.open(container);
                    }
                });
    ...
    check(xml) {
        let number_of_movements = 0;
        let movements_added = 0;
        ...
        xml.querySelectorAll("#eventContent tbody tr").forEach(line => {
            ...
            let tooltipElement = line.querySelector(".icon_movement .tooltip") || line.querySelector(".icon_movement_reserve .tooltip");
            let tooltip = Util.addDom("div", { child: tooltipElement?.getAttribute("title") });

            let movement = {
                id: parseInt(line.getAttribute("id").replace("eventRow-", "")),
                mission: line.getAttribute("data-mission-type"),
                isBack: line.getAttribute("data-return-flight") === "true",
                arrivalTime: parseInt(line.getAttribute("data-arrival-time")) * 1000,
                from: {},
                to: {}
            };
            ...
            // Definir dados de origem
            let originCoords = line.querySelector(".coordsOrigin").innerText.trim().slice(1, -1);
            movement.from = {
                anotherPlayer: !Array.from(document.querySelectorAll("#planetList .planet-koords"))
                    .some(p => p.innerText === originCoords),
                isMoon: Boolean(line.querySelector(".originFleet figure.moon")),
                coords: originCoords
            };

            // Definir dados de destino
            let destCoords = line.querySelector(".destCoords").innerText.trim().slice(1, -1);
            movement.to = {
                anotherPlayer: !Array.from(document.querySelectorAll("#planetList .planet-koords"))
                    .some(p => p.innerText === destCoords),
                isMoon: Boolean(line.querySelector(".destFleet figure.moon")),
                coords: destCoords
            };

            // Marcar destino como atacado se a missão for ataque
            if ([1, 6, 9].includes(parseInt(movement.mission)) && movement.from.anotherPlayer) {
                let destPlanet = Array.from(document.querySelectorAll("#planetList .planet-koords"))
                    .find(p => p.innerText === destCoords);

                if (destPlanet) {
                    let planetElement = destPlanet.closest(".smallplanet");
                    let targetElement = movement.to.isMoon
                        ? planetElement.querySelector(".moonlink")
                        : planetElement.querySelector(".planetlink");

                    targetElement.classList.add("ogl_attacked");
                }
            }

            // Processar informações da frota a partir do tooltip
            tooltip.querySelectorAll(".fleetinfo tr").forEach(subline => {
                let nameElement = subline.querySelector("td");
                let valueElement = subline.querySelector(".value");

                if (nameElement && valueElement) {
                    let name = nameElement.innerText.replace(":", "");
                    let key = Object.entries(this.ogl.db.serverData).find(entry => entry[1] === name)?.[0];
                    let value = valueElement.innerText.replace(/\.|,| /g, "");

                    if (key) {
                        movement[key] = Number(value);
                    }
                }
            });

            // Determinar o alvo do movimento
            let target = movement.isBack
                ? `${movement.from.coords}:B`
                : movement.to.anotherPlayer
                    ? movement.from.coords
                    : movement.from.anotherPlayer
                        ? `${movement.to.coords}:B`
                        : movement.to.coords;

            if (target) {
                movements[target] = movements[target] || [];
                allEvents[target] = allEvents[target] || [];

                if (!ignored.includes(movement.id)) {
                    movements[target].push(movement);
                }

                allEvents[target].push(movement);
                movements_added++;
            }

        });

        // Atualizar cache de eventos e movimentos
        this.ogl.cache.allEvents = allEvents;
        this.ogl.cache.movements = movements;

        // Adicionar ícones de frotas aos planetas
        document.querySelectorAll(".smallplanet").forEach(planet => {
            let coords = planet.querySelector(".planet-koords").innerText;
        ...
        // Executar funções assíncronas relacionadas com os movimentos
        Util.runAsync(() => {
...
class HighscoreManager extends Manager {
    ...
    loadData() {
        ...
        if (1 === currentCategory && typesList[currentType]) {
            this.ogl.db.sortedScores[typesList[currentType]] = [];
            ...
            ts && (ts = Math.floor(Math.abs(serverTime.getTime() - 1e3 * parseInt(ts)) / 36e5),
                ...
                document.querySelectorAll("#ranks tbody tr").forEach(line => {
                    ...
                    if (isNaN(ranking)) {
                        const classList = Array.from(line.querySelector(".position").querySelector("div").classList);
                        const positionClass = classList.find(cls => cls.match(/^position(\d+)$/));

                        if (positionClass) {
                            const match = positionClass.match(/^position(\d+)$/);
                            const positionNumber = match ? parseInt(match[1], 10) : 0;
                            ranking = positionNumber;
                        } else {
                            ranking = 0;
                        }
                    }

                    this.ogl.db.sortedScores[typesList[currentType]].push({playerId: id, position: ranking, score: currentScore});
...
class ShortcutManager extends Manager {
    load() {
        document.querySelector(".ogl_shortcuts")?.remove(), document.querySelector(".ogl_shortCutWrapper")?.remove(),
            ...
            this.loaded = !0, this.add('toMoonFast', () => {
            if (typeof fleetDispatcher !== 'undefined') {
                ...
                if (fleetDispatcher.currentPage == 'fleet1') {
                    ...
                    this.ogl._fleet.setRealTarget(fleetDispatcher.realTarget, {
                        galaxy: coords[0], system: coords[1], position: coords[2], type: 3, name: 'Lua'
                    });
            ...
            if (typeof fleetDispatcher !== 'undefined') {
                if (fleetDispatcher.currentPage == 'fleet1') {
                    const inputElement = document.querySelector('label[data-limiter-type="ship"] input');
                    ...
                    if (fleetDispatcher.expeditionCount >= fleetDispatcher.maxExpeditionCount) {
                        window.location.href = `https://${window.location.host}/game/index.php?page=ingame&component=fleetdispatch`;
                        return;
                    } else {
                        var block = false;
                        ...
                        if (this.ogl.db.expeditionValidation == {}) {

                        } else {
                            fleetDispatcher.shipsToSend.forEach((e => {
                                if (e.id == this.ogl.db.expeditionValidation.ship) {
                                    hasCargo = true;
                                    if (e.number < this.ogl.db.expeditionValidation.shipQt || e.number <= 0) {
                                        block = true;
                                    }
                                } else if (e.id == 219 ) { // Explorer ship id
                                    hasExplorer = true;
                                    if (e.number <= 0) {
                                        block = true;
                                    }
        ...
        }, '', '', true), this.add('scanPlayers', () => {
            const t = new URLSearchParams(window.location.search);

            if (t.get("component") == 'galaxy') {

                const elements = document.querySelectorAll('i');
                elements.forEach(element => {
                    if (element.textContent === 'push_pin') {
                        element.click();

                        setTimeout(() => {
                            const element = document.querySelector('.ogl_flagSelector div[data-flag="danger"]');
                            if (element) {
                                element.click();
                                setTimeout(() => {

                                    const players = document.querySelectorAll('.ogl_list > .ogl_addedElement');
                                    const startTime = performance.now();
                                    var count_players = 0;

                                    if (players.length > 0) {
                                        function scan_player() {
                                            var player = players[count_players];
                                            setTimeout(() => {
                                                const player_name = player.querySelector('span');
                                                if (player_name) {
                                                    player_name.click();
                                                    ...
                                                    setTimeout(() => {
                                                        ...
                                                        function pressKey(key, times, interval) {
                                                            ...
                                                            function sendEvent(key, count) {
                                                                if (count <= times) {
                                                                    const event = createEvent(key);
                                                                    document.dispatchEvent(event);

                                                                    const eventGo = new KeyboardEvent('keyup', {
                                                                        key: key,
                                                                        keyCode: key.toUpperCase().charCodeAt(0),
                                                                        which: key.toUpperCase().charCodeAt(0),
                                                                        bubbles: true
                                                                    });
                                                                    document.dispatchEvent(eventGo);

                                                                    setTimeout(() => sendEvent(key, count + 1), interval);
                                                                } else {
                                                                    if (count_players < (players.length - 1)) {
                                                                        count_players++;
                                                                        setTimeout(() => scan_player(), 2000);
                                                                    } else {
                                                                        window.location.href = `https://${window.location.host}/game/index.php?page=ingame&component=fleetdispatch`;
                                                                        return;
                                                                    }
                ...
                window.location.href = `https://${window.location.host}/game/index.php?page=ingame&component=galaxy`;
            }
        }, '', '', true),  this.add('watchPlayers', () => {
            const t = new URLSearchParams(window.location.search);
            ...
            if (t.get("component") == 'galaxy') {
                ...
                elements.forEach(element => {
                    if (element.textContent === 'push_pin') {
                        ...
                        setTimeout(() => {
                            const element = document.querySelector('.ogl_flagSelector div[data-flag="skull"]');
                            if (element) {
                                element.click();
                                setTimeout(() => {
                                        ...
                                        function watch_player() {
                                            ...
                                            setTimeout(() => {
                                                ...
                                                if (player_name) {
                                                    ...
                                                    setTimeout(() => {
                                                        const home_coords = document.querySelector('.ogl_list .ogl_home div[data-galaxy]');

                                                        if (home_coords) {
                                                            home_coords.click();
                                                        } else {
                                                            const first_coord = document.querySelector('.ogl_list .ogl_addedElement div[data-galaxy]');
                                                            if(first_coord) {
                                                                first_coord.click();
                                                            }
                                                        }
        ...
        }, '', '', true), this.add('expeditionRecFast', () => {
            if (typeof fleetDispatcher !== 'undefined') {
                var fast = true;
                ...
                if (fleetDispatcher.currentPage == 'fleet1') {
                    ...
                    this.ogl._fleet.setRealTarget(fleetDispatcher.realTarget, {
                        galaxy: coords[0], system: coords[1], position: coords[2], type: 2, name: 'Campo de Destroços'
                    });
            ...
            }, '', '', true), this.add("menu", () => (document.querySelector(".ogl_side.ogl_active .ogl_config") ? (this.ogl._ui.side.classList.remove("ogl_active"),
...
class TechManager extends Manager {
        ...
        if (document.querySelector(`#technologies .technology[data-technology="${id}"] .targetlevel`)?.getAttribute("data-value") >= this.initialLevel && (this.initialLevel += 1),
            ...
            amount.parentNode.querySelector(".maximum") && amount.parentNode.querySelector(".maximum").addEventListener("click", () => amount.dispatchEvent(new Event("input"))),
                Util.addDom("div", {
                    ...
                    onclick: e => {
                        this.todoData = {};
                        var number = amount.value && 0 < amount.value ? amount.value : 1, data = Util.getTechData(this.ogl, id, number, this.ogl.currentPlanet.obj.id);
            ...
            onclick: e => {
                if (0 <= this.levelOffset) {
                    ...
                    for (let i = this.initialLevel; i <= this.initialLevel + this.levelOffset; i++) {
                        var data = Util.getTechData(this.ogl, id, i, this.ogl.currentPlanet.obj.id);
    ...
    displayLevel(id, lvl, data, details) {
        let techData = Util.getTechData(this.ogl, id, lvl, this.ogl.currentPlanet.obj.id), cumul = {};
        ...
        for (var [ cumulLvl, cumulCost ] of Object.entries(this.detailCumul[id] || {})) cumulLvl >= this.initialLevel && cumulLvl <= this.initialLevel + this.levelOffset && Object.entries(cumulCost).forEach(entry => {
            "timeresult" == entry[0] || "energy" == entry[0] || "population" == entry[0] ? cumul[entry[0]] = entry[1] : cumul[entry[0]] = (cumul[entry[0]] || 0) + entry[1];
        });
        unsafeWindow.technologyDetails && (technologyDetails.id = id, technologyDetails.lvl = lvl),
        !details.querySelector("[data-debug]") && (details.querySelector(".build_duration time").setAttribute("data-debug", details.querySelector(".build_duration time").innerText+ "asdads"),
        ...
        details.querySelector(".build_duration time").setAttribute("data-debug", Util.secondsToString(cumul['duration'] / 1000));
                ...
                if (document.querySelector(`#${box[1]} time`)) {
                    ...
                    document.querySelectorAll(`#${[ box[1] ]} .queuePic`).forEach((item, index) => {
                        ...
                        if (id) {
                            ...
                            var item = item.closest(".first")?.parentNode?.querySelector(".level")?.innerText.match(/\d+/)[0] || item.closest(".first")?.querySelector(".shipSumCount")?.innerText || item.parentNode.innerText, data = Util.getTechData(this.ogl, id, item, this.ogl.currentPlanet.obj.id), data = 0 == index ? 1e3 * parseInt(document.querySelector(`#${[ box[1] ]} time.countdown`).getAttribute("data-end")) || serverTime.getTime() + data.target.duration : data.target.duration;
                        ...
                        ` + new Date(data).toLocaleTimeString("de-DE"));
                                let u = {
                                    points: 0,
                                    name: this.ogl.db.serverData[id] || id,
                                    lvl: item,
                                    end: itemEndTime,
                                    type: techType
                                };
                                const p = Object.values(this.ogl.db.myPlanets).find((x => x.coords == this.ogl.currentPlanet.obj.coords && "planet" == x.type))?.id;

                                const dados = Util.getTechData(this.ogl, id, u.lvl, p);
                                u.points = parseInt((dados.target.metal + dados.target.crystal + dados.target.deut) / 1000);
                                Util.addDom("time", {
                                    class: "ogl_timeBox",
                                    prepend: div.querySelector(".build-faster").parentNode,
                                    child: data
                                }), "baseResearch" == techType && ((div = u).name = this.ogl.db.serverData[id] || id,
...
class StatsManager extends Manager {
    ...
    displayDetails(dataset, parent, keyStart, keyEnd) {
        ...
        [ "", "send", "metal", "crystal", "deut", "msu", "dm", "artefact" ].forEach(resource => {
        ...
        }), [ "expe", "debris16", "invisible", "raid", "debris", "invisible", "conso", /*"u"*/, "invisible", "total" ].forEach(type => {
            if (type == "invisible") {
                Util.addDom("div", {
                    class: "ogl_invisible",
                    parent: sumTable
            ...
            let line = Util.addDom("div", {
                parent: sumTable,
                child: `<div>${this.ogl._lang.find(typeLabel)}</div>`
            });
            var typeLabel = {}, missions = (typeLabel.expe = data.expe.count, typeLabel.debris16 = data.debris16.count,
                typeLabel.raid = data.raid.count, typeLabel.debris = data.debris.count, typeLabel.total = data.debris.count + data.debris16.count + data.expe.count + data.raid.count + data.discovery.count,
                Util.addDom("div", {
                    parent: line,
...
class Util {
    ...
    static sendDiscord(message, type = '') {
        const RCID = '';
        var request = {
            'message': message,
            'request_type': type,
...
// AQUI
        GM_xmlhttpRequest(
            {
                method: 'POST',
                url: 'https://gt.correia.red/api/toDiscord',
                data: JSON.stringify(request),
                headers: {
                    "Content-Type": "application/json",
                    "Access-Control-Allow-Origin": "*",
    ...
    static sendToGalaxyTool(info) {
        ...
        GM_xmlhttpRequest(
            {
                method: 'POST',
                url: 'https://gt.correia.red/api/galaxy',
                data: JSON.stringify(request),
                headers: {
                    "Content-Type": "application/json",
                    "Access-Control-Allow-Origin": "*",
    ...
    static getTechData(ogl, id, level, planetID) {
        if (id) {
            var data = Datafinder.getTech(id), planetData = ogl.db.myPlanets[planetID] || {};
            ...
            document.querySelectorAll(".smallplanet").forEach(line => {
                var line = line.getAttribute("id").replace("planet-", ""), colo = ogl.db.myPlanets[line];
            ...
            var planet = {}, tech = (planet.lifeform = planetData.lifeform || 0,
                ...
                tech.bonus.conso = 0, tech.bonus.prodEnergy = 0, 1 == ogl.account.class && (tech.bonus.prodEnergy += .1),
            2 == ogl.db.allianceClass && (tech.bonus.prodEnergy += .05), 2 == planet.lifeform ? (tech.bonus.prodEnergy += planetData[12107] * Datafinder.getTech(12107).bonus1BaseValue / 100,
            ...
            tech.isBaseResearch && 3 == ogl.account.class && (tech.bonus.classDuration += .25 * (1 + (ogl.db.lfBonuses?.Characterclasses3?.bonus || 0) / 100)),
            ...
            tech.isLfResearch && (1 == planet.lifeform ? (tech.bonus.price += planetData[11103] * Datafinder.getTech(11103).bonus1BaseValue / 100,
                ...
                tech.bonus.price += (ogl.db.lfBonuses?.LfResearch?.cost || 0) / 100,
                tech.bonus.duration += (ogl.db.lfBonuses?.LfResearch?.duration || 0) / 100),
            ...
            (tech.isBaseResearch || tech.isBaseDef || tech.isBaseShip) && (tech.bonus.price += (ogl.db.lfBonuses?.[tech.id]?.cost || 0) / 100,
                tech.bonus.duration += (ogl.db.lfBonuses?.[tech.id]?.duration || 0) / 100),
            ...
            ogl.db.options.debugMode && console.log(JSON.parse(JSON.stringify(tech))),
                ...
                tech.target.duration = tech.target.duration / (ogl.server.economySpeed * (tech.isBaseResearch ? ogl.db.serverData.researchSpeed : 1)) * (1 - tech.bonus.eventDuration) * (1 - tech.bonus.classDuration) * (1 - tech.bonus.technocrat) * (1 - Math.min(tech.bonus.duration, .99)),
...
class PTRE {
    ...
    displayLogs() {
        ...
        0 < this.ogl.cache.ptreLogs?.length ? (this.ogl.cache.ptreLogs.forEach(log => {
            ...
            child: "<div>time</div><div>"+this.ogl._lang.find('errorCode')+"</div><div>"+this.ogl._lang.find('message')+"</div>",
            prepend: container
        })) : Util.addDom("div", {
            child: this.ogl._lang.find('empty'),
            parent: container
        }), Util.addDom("div", {
            child: "<h2>"+this.ogl._lang.find('ptreErrors')+"</h2>",
            prepend: container
        }), this.ogl._popup.open(container, !0);
    }
