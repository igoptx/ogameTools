...
class TopbarManager extends Manager {
    ...
    upgradeList() {
        ...
        if (me.playerId != undefined) {
            let target = {};
            for (let i = 0; i < this.ogl.db.sortedScores.length; i++) {
                if (this.ogl.db.sortedScores[i].score < (me.score + totalPoints)) {
            ...
            Util.addDom("div", { class: "ogl_invisible", parent: upgradeListDiv });
            Util.addDom("div", { class: "ogl_invisible", parent: upgradeListDiv });
            Util.addDom("div", { child: "Posição esperada", parent: upgradeListDiv });
            Util.addDom('div', { child: `(+${me.position - target.position}) ${target.position}º lugar`, parent: upgradeListDiv });
        }
