...
class OGLight {
    ...
    updateJQuerySettings() {
        ...
        $(document).on("ajaxSend", (function (t, n, o) {
            if (o.url.indexOf("component=messages&tab=") >= 0) {
            ...
            else if (o.url.indexOf("component=messages") >= 0) {
            ...
            document.querySelectorAll(".planetlink, .moonlink").forEach((e => {
                ...
                for (let [e] of Object.entries(o))
                    if (o[e]) {
                        ...
                        if (a.id > 0) {
                            const data = Util.getTechData(a.id, a.lvl, n);
...
class UIManager extends Manager {
    load(e) {
        document.querySelector("#planetList").classList.add("ogl_ogameDiv"), document.querySelector(".ogl_side") || (this.side = Util.addDom("div", {
            ...
            parent: this.resourceDiv,
            child: "0"
        })), Util.addDom('div', {class:'ogl_icon ogl_defaultship', parent:this.resourceDiv, child:'0'}), Util.addDom('div', {class:'ogl_icon ogl_customsplit', parent:this.resourceDiv, child:'0'}), e || (Util.addDom("li", {
        ...
        e || (document.addEventListener("keyup", (e => {
            ...
            if ("svg" != e.target.tagName && "path" != e.target.tagName) {
                ...
                if ((e.target.classList.contains("planetlink") || e.target.classList.contains("moonlink") || e.target.closest(".planetlink, .moonlink")) && document.body.classList.contains("ogl_destinationPicker")) {
                    ...
                    if (document.body.classList.contains("ogl_initHarvest")) window.location.href = `https://${window.location.host}/game/index.php?page=ingame&component=fleetdispatch&galaxy=${t[0]}&system=${t[1]}&position=${t[2]}&type=${n}&oglmode=1`;
                    else {
...
class TopbarManager extends Manager {
    ...
    openSettings(e) {
        ...
        let n;
        ["defaultShip", "defaultMission", "profileButton", "resourceTreshold", 'customSplit', "msu", "sim", "converter", "useClientTime", "keyboardActions", "showMenuResources", "tooltipDelay", "shortcutsOnRight", "disablePlanetTooltips", "reduceLargeImages", "displayPlanetTimers", 'showMissionsSplitted', "expeditionValue", "expeditionRandomSystem", "expeditionRedirect", "expeditionBigShips", "expeditionShipRatio", "ignoreExpeShipsLoss", "ignoreConsumption", "displaySpyTable", "autoCleanReports", "boardTab", "ptreTeamKey", "ptreLogs", "manageData", "debugMode"].forEach((e => {
            ...
            if ("TEXT_NOT_FOUND" != l && (r.classList.add("tooltipLeft"), r.setAttribute("title", l)), "defaultShip" == e) this.ogl.fretShips.forEach((e => {
                ...
                const input = Util.addDom('input', { type:'text', placeholder:'placeholder', value:this.ogl.db.options[e], parent:r,
                    oninput:() =>
                    {
...
class FleetManager extends Manager {
    ...
    fleetSent(e) {
        ...
        if (n.conso = (n.conso || 0) + Math.min(this.initialResOnPlanet.deut, t), this.isQuickRaid && this.ogl.db.quickRaidList.shift(), 5 === this.ogl.mode && 15 !== fleetDispatcher.mission && this.ogl.db.options.expeditionRedirect && (this.ogl.mode = 0), 1 != this.ogl.mode && 2 != this.ogl.mode && 5 != this.ogl.mode && this.prepareRedirection(), 1 === this.ogl.mode || 2 === this.ogl.mode || 5 === this.ogl.mode && this.ogl.db.options.expeditionRedirect) window.location.href = this.ogl.nextRedirection;
            ...
            this.ogl.cache.reports[e] && (this.ogl.cache.reports[e].attacked = !0), window.location.href = `https://${window.location.host}/game/index.php?page=ingame&component=messages`
        }
    ...
    prepareRedirection() {
        ...
        }, s = `${this.ogl.db.harvestCoords?.source?.galaxy}:${this.ogl.db.harvestCoords?.source?.system}:${this.ogl.db.harvestCoords?.source?.position}`)), 1 === this.ogl.mode ? (a = 1 == this.ogl.db.harvestCoords?.source?.type ? this.ogl.currentPlanet.dom.prev.getAttribute("id").replace("planet-", "") : this.ogl.currentPlanet.dom.prevWithMoon.querySelector(".moonlink").getAttribute("href").match(/cp=(\d+)/)[1], i = 1 == this.ogl.db.harvestCoords?.source?.type ? this.ogl.currentPlanet.dom.next.getAttribute("id").replace("planet-", "") : this.ogl.currentPlanet.dom.nextWithMoon.querySelector(".moonlink").getAttribute("href").match(/cp=(\d+)/)[1], e || l != t || fleetDispatcher.currentPlanet.type != fleetDispatcher.realTarget.type || (i = 1 == this.ogl.db.harvestCoords?.source?.type ? this.ogl.currentPlanet.dom.nextNext.getAttribute("id").replace("planet-", "") : this.ogl.currentPlanet.dom.nextNextWithMoon.querySelector(".moonlink").getAttribute("href").match(/cp=(\d+)/)[1]), this.ogl.prevRedirection = `https://${window.location.host}/game/index.php?page=ingame&component=fleetdispatch&cp=${a}&galaxy=${r[0]}&system=${r[1]}&position=${r[2]}&type=${o}&oglmode=1`, this.ogl.nextRedirection = `https://${window.location.host}/game/index.php?page=ingame&component=fleetdispatch&cp=${i}&galaxy=${r[0]}&system=${r[1]}&position=${r[2]}&type=${o}&oglmode=1`) : 2 === this.ogl.mode ? (a = 1 == this.ogl.db.harvestCoords?.source?.type ? this.ogl.currentPlanet.dom.prevWithMoon.getAttribute("id").replace("planet-", "") : this.ogl.currentPlanet.dom.prevWithMoon.querySelector(".moonlink").getAttribute("href").match(/cp=(\d+)/)[1], i = 1 == this.ogl.db.harvestCoords?.source?.type ? this.ogl.currentPlanet.dom.nextWithMoon.getAttribute("id").replace("planet-", "") : this.ogl.currentPlanet.dom.nextWithMoon.querySelector(".moonlink").getAttribute("href").match(/cp=(\d+)/)[1], this.ogl.prevRedirection = `https://${window.location.host}/game/index.php?page=ingame&component=fleetdispatch&cp=${a}&oglmode=2`, this.ogl.nextRedirection = `https://${window.location.host}/game/index.php?page=ingame&component=fleetdispatch&cp=${i}&oglmode=2`) : 5 === this.ogl.mode && (a = 1 == this.ogl.db.harvestCoords?.source?.type ? this.ogl.currentPlanet.dom.prev.getAttribute("id").replace("planet-", "") : this.ogl.currentPlanet.dom.prevWithMoon.querySelector(".moonlink").getAttribute("href").match(/cp=(\d+)/)[1], i = 1 == this.ogl.db.harvestCoords?.source?.type ? this.ogl.currentPlanet.dom.next.getAttribute("id").replace("planet-", "") : this.ogl.currentPlanet.dom.nextWithMoon.querySelector(".moonlink").getAttribute("href").match(/cp=(\d+)/)[1], this.ogl.prevRedirection = `https://${window.location.host}/game/index.php?page=ingame&component=fleetdispatch&cp=${a}&oglmode=5`, this.ogl.nextRedirection = `https://${window.location.host}/game/index.php?page=ingame&component=fleetdispatch&cp=${i}&oglmode=5`), (s == t || t == l && s == n && this.ogl.db.harvestCoords?.source?.type == this.ogl.db.harvestCoords?.destination?.type) && (this.ogl.db.harvestCoords = void 0, this.ogl.nextRedirection = `https://${window.location.host}/game/index.php?page=ingame&component=overview&cp=${i}`), this.redirectionReady = !0
    }
...
class MessageManager extends Manager {
        ...
        if (unsafeWindow.tippy) {
            ...
            20 == this.tabID && (this.spytable = document.querySelector(".ogl_spytable"), this.spytable ? this.spytable.classList.remove("ogl_hidden") : (this.spytable = Util.addDom("div", {
                ...
                if (a.id = n.getAttribute("data-msg-id"), 20 == this.tabID) {
                    var data_raw_defense = o.getAttribute("data-raw-defense");
                    if (data_raw_defense == '-') {
                        data_raw_defense = '[]';
                    }

                    a.playerID = o.getAttribute("data-raw-targetplayerid"), a.planetID = o.getAttribute("data-raw-targetplanetid"), a.playerName = o.getAttribute("data-raw-playerName"), a.targetType = 1 == o.getAttribute("data-raw-targetPlanetType") ? "planet" : "moon", a.targetTypeID = o.getAttribute("data-raw-targetPlanetType"), a.coords = o.getAttribute("data-raw-coordinates"), a.date = 1e3 * parseInt(o.getAttribute("data-raw-dateTime")), a.age = 1e3 * parseInt(o.getAttribute("data-raw-reportAge")), a.activity = o.getAttribute("data-raw-activity"), a.resources = parseInt(o.getAttribute("data-raw-resources")), a.metal = parseInt(o.getAttribute("data-raw-metal")), a.crystal = parseInt(o.getAttribute("data-raw-crystal")), a.deut = parseInt(o.getAttribute("data-raw-deuterium")), a.fleet = o.getAttribute("data-raw-fleet"), a.def = JSON.parse(data_raw_defense || "{}"), a.loot = parseInt(o.getAttribute("data-raw-loot")), a.wave1 = Math.floor(a.resources * a.loot / 100), a.wave2 = Math.floor(a.wave1 * a.loot / 100), a.wave3 = Math.floor(a.wave2 * a.loot / 100), a.wave4 = Math.floor(a.wave3 * a.loot / 100), a.wave5 = Math.floor(a.wave4 * a.loot / 100), a.wave6 = Math.floor(a.wave5 * a.loot / 100), a.fleetValue = 0, a.defValue = 0;
        ...
        for (let t = 1; t < 7; t++) {
            ...
            this.ogl.fretShips.forEach((t => {
                ...
                Util.addDom("a", {
                    ...
                    href: `https://${window.location.host}/game/index.php?page=ingame&component=fleetdispatch&galaxy=${n[0]}&system=${n[1]}&position=${n[2]}&type=${e.targetTypeID}&mission=1&am${t}=${i}&oglmode=4&oglLazy=true`
                })
            }))
        }
        Util.addDom("span", {
    ...
    deleteMessage() {
        ...
        $.ajax({
            type: "POST",
            url: "?page=ingame&component=messages",
            dataType: "json",
            data: n,
            success: n => {
    ...
    buildTable() {
        ...
        Object.values(this.ogl.cache.reports).sort((function (n, o) {
                        ...
                        for (let a = 0; a < 6; a++) {
                            ...
                            this.ogl.fretShips.forEach((t => {
                                ...
                                Util.addDom("a", {
                                    ...
                                    href: `https://${window.location.host}/game/index.php?page=ingame&component=fleetdispatch&galaxy=${e.coords[0]}&system=${e.coords[1]}&position=${e.coords[2]}&type=${e.typeID}&mission=1&am${t}=${o}&oglmode=4&oglLazy=true`
                                })
                            })), e.more = !0
                        }
                    }
            ...
            const d = Util.addDom("a", {
                ...
                parent: l.querySelector(".ogl_actions"),
                child: "target",
                href: `https://${window.location.host}/game/index.php?page=ingame&component=fleetdispatch&galaxy=${e.coords[0]}&system=${e.coords[1]}&position=${e.coords[2]}&type=${e.typeID}&mission=1`
            });
    ...
    checkRaids(e, t) {
        ...
        document.querySelector(`.ui-tabs-panel[aria-labelledby="${n}"]`).querySelectorAll(".msg").forEach((e => {
            ...
            o.setAttribute("data-api-code", a), Util.addDom("div", {
                ...
                url: `https://${window.location.host}/game/index.php?page=ingame&component=messages&messageId=${n}&tabid=21&ajax=1`,
                callback: o => {
    ...
    load() {
        document.querySelector(".ogl_shortcuts")?.remove(), document.querySelector(".ogl_shortCutWrapper")?.remove(), this.keyList = {}, this.shortCutWrapper = Util.addDom("div", {
            ...
            if (this.ogl._message.nextTarget) {
                ...
                window.location.href = `https://${window.location.host}/game/index.php?page=ingame&component=fleetdispatch&galaxy=${e.coords[0]}&system=${e.coords[1]}&position=${e.coords[2]}&type=${3==e.type?3:1}&mission=1&am${this.ogl.db.options.defaultShip}=${t}&oglmode=4&oglmsg=${e.id}`
            }
...
class TechManager extends Manager {
            ...
            a.addEventListener("input", (() => {
                ...
                onclick: t => {
                    ...
                    const n = a.value && a.value > 0 ? a.value : 1,
                        o = Util.getTechData(e, n, this.ogl.currentPlanet.obj.id);
            ...
            onclick: t => {
                if (this.levelOffset >= 0) {
                    ...
                    for (let t = this.initialLevel; t <= this.initialLevel + this.levelOffset; t++) {
                        const n = Util.getTechData(e, t, this.ogl.currentPlanet.obj.id);
    ...
    displayLevel(e, t, n, o) {
        const a = Util.getTechData(e, t, this.ogl.currentPlanet.obj.id),
            i = {};
            ...
            if (document.querySelector(`#${e[1]} time`)) {
                ...
                document.querySelectorAll(`#${[e[1]]} .queuePic`).forEach(((i, r) => {
                    ...
                    const s = i.closest(".first")?.parentNode?.querySelector(".level")?.innerText.match(/\d+/)[0] || i.closest(".first")?.querySelector(".shipSumCount")?.innerText || i.parentNode.innerText,
                        d = Util.getTechData(l, s, this.ogl.currentPlanet.obj.id),
                    ...
                    if (o += c, 0 == r) {
                        ...
                        const data = Util.getTechData(l, s, p);
    ...
    update(e, t, n) {
        ...
        (e = n ? JSON.parse(e.match(/{(.*)}/g)[1]) : e).planets.forEach((e => {
            this.ogl.db.myPlanets[e.id] = this.ogl.db.myPlanets[e.id] || {}, this.ogl.db.myPlanets[e.id].type = 0 === t ? "planet" : "moon", Object.entries(e).forEach((t => {
                t[0].indexOf("html") >= 0 || ("temperature" === t[0] ? this.ogl.db.myPlanets[e.id][t[0]] = parseInt(t[1].match(/[-|0-9]+/g, "")[0]) : Number(t[0]) || t[0].indexOf("Storage") >= 0 || o.includes(t[0]) ? this.ogl.db.myPlanets[e.id][t[0].replace("deuterium", "deut")] = parseInt(t[1]) : "coordinates" === t[0] ? this.ogl.db.myPlanets[e.id].coords = t[1].slice(1, -1) : "name" === t[0] ? this.ogl.db.myPlanets[e.id].name = t[1] : "production" === t[0] && (this.ogl.db.myPlanets[e.id].prodMetal = t[1].hourly[0] / 3600, this.ogl.db.myPlanets[e.id].prodCrystal = t[1].hourly[1] / 3600, this.ogl.db.myPlanets[e.id].prodDeut = t[1].hourly[2] / 3600))
            }))
